...
const UserForm = () => {
  ...
  return (
    <div className="main bg-[#121a24] h-screen w-full fixed">
      ...
      <div className="button grid grid-cols-1 gap-2 mx-[428px]">
        <button className="group relative text-white bg-[#343c4c] mt-10 px-4 rounded flex items-center justify-center overflow-hidden w-full h-12">
          <Link to="/user-data" className="flex items-center space-x-2">
            <FaRegUserCircle
              className="text-2xl transform transition-transform duration-300 group-hover:-translate-x-2 ml-24"
            />
            <span className="transform left-1/2 transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:translate-x-0">
              Show Users
            </span>
          </Link>
        </button>
